...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Invoice.total_paid'
        db.delete_column('artshow_invoice', 'total_paid')


    def backwards(self, orm):
        
        # Adding field 'Invoice.total_paid'
        db.add_column('artshow_invoice', 'total_paid', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True), keep_default=False)
