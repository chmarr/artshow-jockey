...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BatchScan.original_data'
        db.add_column(u'artshow_batchscan', 'original_data',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BatchScan.original_data'
        db.delete_column(u'artshow_batchscan', 'original_data')
    ...
    models = {
        ...
        u'artshow.batchscan': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_data': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
