...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Piece.code'
        db.add_column('artshow_piece', 'code', self.gf('django.db.models.fields.CharField')(default='X', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Piece.code'
        db.delete_column('artshow_piece', 'code')
