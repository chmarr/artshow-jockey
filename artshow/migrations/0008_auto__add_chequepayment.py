...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('artshow_chequepayment', (
            ('payment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['artshow.Payment'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('artshow', ['ChequePayment'])


    def backwards(self, orm):
        
        # Deleting model 'ChequePayment'
        db.delete_table('artshow_chequepayment')
