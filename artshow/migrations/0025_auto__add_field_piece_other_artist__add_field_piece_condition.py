...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Piece.other_artist'
        db.add_column('artshow_piece', 'other_artist',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Piece.condition'
        db.add_column('artshow_piece', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Piece.other_artist'
        db.delete_column('artshow_piece', 'other_artist')

        # Deleting field 'Piece.condition'
        db.delete_column('artshow_piece', 'condition')
