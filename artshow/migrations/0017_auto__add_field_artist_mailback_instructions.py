...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.mailback_instructions'
        db.add_column('artshow_artist', 'mailback_instructions',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.mailback_instructions'
        db.delete_column('artshow_artist', 'mailback_instructions')
