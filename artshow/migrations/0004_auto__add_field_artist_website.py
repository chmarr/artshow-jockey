...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('artshow_artist', 'website', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.website'
        db.delete_column('artshow_artist', 'website')
