...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvoicePayment.notes'
        db.add_column('artshow_invoicepayment', 'notes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvoicePayment.notes'
        db.delete_column('artshow_invoicepayment', 'notes')
