...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Allocation', fields ['space', 'artist']
        db.create_unique('artshow_allocation', ['space_id', 'artist_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Allocation', fields ['space', 'artist']
        db.delete_unique('artshow_allocation', ['space_id', 'artist_id'])
