...
// Added "pad" option to toString() by Chris Cogdon
...
with({$: BigNumber, o: BigNumber.prototype}){
	...
	o.valueOf = o.toString = function( pad ){
		var o = this;
		return (o._s ? "-" : "") + (o._d.slice(0, o._f).join("") || "0") + (o._f != o._d.length || pad ? "." : "" ) + ( o._f != o._d.length ? o._d.slice(o._f).join("") : "" ) + ( pad ? new Array ( o.precision - o._d.length + o._f + 1 ).join("0") : "" );
	};
