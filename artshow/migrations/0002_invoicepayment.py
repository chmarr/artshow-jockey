...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('artshow_invoicepayment', (
        ...
        db.send_create_signal('artshow', ['InvoicePayment'])

        # Deleting field 'Invoice.payment_method'
        db.delete_column('artshow_invoice', 'payment_method')


    def backwards(self, orm):
        
        # Deleting model 'InvoicePayment'
        db.delete_table('artshow_invoicepayment')

        # Adding field 'Invoice.payment_method'
        db.add_column('artshow_invoice', 'payment_method', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
