...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Piece.bid_sheet_printing'
        db.add_column('artshow_piece', 'bid_sheet_printing',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Piece.control_form_printing'
        db.add_column('artshow_piece', 'control_form_printing',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Piece.bid_sheet_printing'
        db.delete_column('artshow_piece', 'bid_sheet_printing')

        # Deleting field 'Piece.control_form_printing'
        db.delete_column('artshow_piece', 'control_form_printing')
