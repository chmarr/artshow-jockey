...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('artshow_piece', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 1, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Piece.updated'
        db.delete_column('artshow_piece', 'updated')
