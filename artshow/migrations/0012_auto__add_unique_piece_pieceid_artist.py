...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Piece', fields ['pieceid', 'artist']
        db.create_unique('artshow_piece', ['pieceid', 'artist_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Piece', fields ['pieceid', 'artist']
        db.delete_unique('artshow_piece', ['pieceid', 'artist_id'])
