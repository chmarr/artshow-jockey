...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Agent'
        db.create_table(u'artshow_agent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='agenting', to=orm['peeps.Person'])),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='agent2', to=orm['artshow.Artist'])),
            ('can_edit_spaces', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('can_edit_pieces', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('can_deliver_pieces', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('can_retrieve_pieces', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('can_arbitrate', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'artshow', ['Agent'])


    def backwards(self, orm):
        # Deleting model 'Agent'
        db.delete_table(u'artshow_agent')
