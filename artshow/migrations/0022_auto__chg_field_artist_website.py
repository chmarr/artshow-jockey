...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('artshow_artist', 'website', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Artist.website'
        db.alter_column('artshow_artist', 'website', self.gf('django.db.models.fields.CharField')(max_length=200))
