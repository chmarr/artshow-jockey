...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Space.allow_half_spaces'
        db.add_column(u'artshow_space', 'allow_half_spaces',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Space.allow_half_spaces'
        db.delete_column(u'artshow_space', 'allow_half_spaces')
