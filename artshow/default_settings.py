...
# Various settings for your show
...
# Override these to use your own forms, while keeping the same
# text placement used in artshow.preprint
...
ARTSHOW_PREPRINT_MODULE = "artshow.preprint"
