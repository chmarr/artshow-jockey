...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('artshow_invoice', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Invoice.paid_date'
        db.alter_column('artshow_invoice', 'paid_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Invoice.created_by'
        db.delete_column('artshow_invoice', 'created_by_id')


        # Changing field 'Invoice.paid_date'
        db.alter_column('artshow_invoice', 'paid_date', self.gf('django.db.models.fields.DateField')(null=True))
