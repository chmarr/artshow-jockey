...
class ArtistAdmin ( AjaxSelectAdmin ):
	...
	actions = ('send_email','print_bidsheets','print_control_forms','apply_space_fees','apply_winnings_and_commission','create_cheques','allocate_spaces','create_management_users')
