...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.person'
        db.add_column('artshow_artist', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['peeps.Person'], null=True),
                      keep_default=False)

        # Adding field 'Bidder.person'
        db.add_column('artshow_bidder', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['peeps.Person'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.person'
        db.delete_column('artshow_artist', 'person_id')

        # Deleting field 'Bidder.person'
        db.delete_column('artshow_bidder', 'person_id')
