...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bidder.at_con_contact'
        db.add_column('artshow_bidder', 'at_con_contact',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bidder.at_con_contact'
        db.delete_column('artshow_bidder', 'at_con_contact')
